...
plot(degree_domain(GFN, "in"), nonzero_degree_distribution(GFN, "in"), main="GitHub Repository Fork Network In-Degree Distribution", xlab="in-degree", ylab="p(in-degree)", log="xy"  )
